...
<body>
<h1>Справка за последните n брой отдадени книги, подредени по дни на заемане</h1><br>
<form method="post">
Дни на заемане:<input type="text" name="text"><br>
Дата на заемане:<input type="date" name="date_take">
Брой книги:<input type="number" name="limit" min="1">
...
ORDER BY Rent_days DESC, Rent_Date DESC 
LIMIT $limit";
